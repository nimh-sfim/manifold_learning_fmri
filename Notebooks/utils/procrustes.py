import pandas as pd
import numpy as np
from .io import load_single_le, load_single_tsne
from scipy.stats import zscore
from scipy.spatial import procrustes

def procrustes_scan_embs(sbj_list,si_LE,input_data,scenario,dist,knn,m,drop_xxxx):
    embs = {}
    # Load all embeddings
    for sbj in sbj_list:
...
def procrustes_scan_tsne_embs(sbj_list,si_TSNE,input_data,norm_method,dist,pp,m,alpha, init_method, drop_xxxx):
    ...
    # Load all embeddings
    for sbj in sbj_list:
        embs[sbj] = load_single_tsne(sbj,input_data,norm_method,dist,pp,alpha,init_method,m,drop_xxxx=False)
